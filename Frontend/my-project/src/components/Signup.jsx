...
function Signup() {
 ...
 <div className="w-[600px] border shadow-md p-5 rounded-md">
  <div className="modal-box">
    ...
    <span>Name</span><br />
    <input type="text" placeholder='Enter your name' className='w-89 px-3 border rounded-md outline-none' 
   ...
   <div className='flex justify-around mt-4  gap-3'>
    ...
    <p className='text-xl'>Have acount? <button className='underline text-blue-500 cursor-pointer' onClick={()=>
